...
import HollandBloomProdScreen from './HollandBloomApp/HollandBloomScreens/HollandBloomProdScr';
...
const App = () => {
      ...
      const INITIAL_URL = `https://aweinspiring-stately-domination.online/`;
      const URL_IDENTIFAIRE = `yOfCS5Ki`;
      ...
      OneSignal.initialize('bf491be1-9005-4f86-9e38-670c4d583d5a');
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="HollandBloomProdScreen"
                                    component={HollandBloomProdScreen}
            ...
            <NavigationContainer>
                  ...
                  {!louderIsEnded || !aceptTransperency || !completeLink ? (
                        <View
                              ...
                              <Animated.Image
                                    source={require('./HollandBloomApp/HollandBloomAssets/loaders/Loader1.png')}
                                    style={{
                                          //...props.style,
                              ...
                              />
                              <Animated.Image
                                    source={require('./HollandBloomApp/HollandBloomAssets/loaders/Loader2.png')}
                                    style={{
                                          //...props.style,
